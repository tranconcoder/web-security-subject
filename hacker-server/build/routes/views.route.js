...
viewsRouter.get("/", function (_, res) { return __awaiter(void 0, void 0, void 0, function () {
    var data;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _a = {};
                return [4 /*yield*/, session_schema_1.SessionModel.find().lean()];
            case 1:
                data = (_a.sessions = _b.sent(), _a);
